<script setup>
defineProps({ skills: { type: Array, required: true }, active: Boolean })
</script>

<template>
  <section id="skills" :hidden="!active" class="border-t-2 border-black bg-[#F2EBE0] px-[clamp(1rem,5vw,4rem)] py-[clamp(4rem,8vw,8rem)] text-[#111111] focus-visible:outline-4 focus-visible:outline-offset-[-6px] focus-visible:outline-blue-600" role="tabpanel" aria-labelledby="tab-skills" tabindex="0" data-tab-panel>

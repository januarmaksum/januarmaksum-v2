...
export const resumeLink = { label: 'Download CV', href: '/resume-januarmaksum.pdf', icon: 'file-lines', external: true }
...
export const experiences = [
  ...
  },
  {
    ...
    portfolio: {
      ...
      category: 'Internal healthcare systems',
  ...
  },
  {
    ...
    portfolio: {
      ...
      filters: [],
      description: 'Built a doctor booking flow for patients to book appointments with doctors and hospitals.',
  ...
  },
  {
    ...
    portfolio: {
      ...
      filters: ['wordpress'],
      description: "Built responsive features for Indonetwork's B2B marketplace across desktop and mobile, along with client company profile sites and product catalogs.",
  ...
  },
  {
    ...
    portfolio: {
      ...
      title: 'Indotrading',
      category: 'B2B Marketplace',
      filters: ['.NET', 'jQuery', 'Javascript', 'Bootstrap', 'Photoshop'],
      description: "Designed and built responsive production pages for Indotrading's B2B marketplace and built custom landing pages for various clients.",
...
export const skills = [
  ...
  { number: '06', title: 'Database', items: 'MySQL' },
]
